...
const TravelFormPage = () => {
  ...
  const validateToDate = (value: string, startDate: string): string | undefined => {
      ...
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {errors.travelers && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.travelers}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.flyingFrom && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.flyingFrom}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.flyingTo && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.flyingTo}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.fromDate && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.fromDate}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.toDate && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.toDate}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.budget && (
              <p className="mt-2 text-sm text-red-500 text-center">{errors.budget}</p>
            )}
          </div>
